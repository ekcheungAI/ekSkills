...
- **[myco](https://github.com/goondocks-co/myco)** (goondocks-co, Apache-2.0) — Myco is the nervous system for AI-assisted software teams. Works automatically alongside the coding agents, subagents, and agent teams you already use
- **[overdeck](https://github.com/eltmon/overdeck)** (eltmon, MIT) — Multi-agent orchestration for AI coding assistants
- **[zAI-Skills](https://github.com/Aznatkoiny/zAI-Skills)** (Aznatkoiny, MIT) — Claude Code plugin marketplace — AI/ML toolkit, consulting frameworks, and real estate investment analysis
- **[skill-md-inspector](https://github.com/Krusty84/skill-md-inspector)** (Krusty84, MIT) — Write, validate, and compare Agent Skills without leaving Visual Studio Code. SKILL.md Inspector gives every file named exactly SKILL.md live feedback, guided fixes, readable reports, and workspace-wide collision checks.
- **[aimeat-protocol](https://github.com/miikkij/aimeat-protocol)** (miikkij, MIT) — Open protocol and reference node where humans, their AI agents, and local LLMs share apps, knowledge, and capabilities. Self-hosted, federated, MIT.
