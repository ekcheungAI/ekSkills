...
- **[potion](https://github.com/Ian-Louw/potion)** (Ian-Louw, MIT) — The magic potion for Claude Code — plans are prompts, disk is memory, evidence or it didn't happen. A lean phase-loop plugin: 13 skills, 2 agents, 4 hooks.
- **[blue-pencil](https://github.com/ipeirotis/blue-pencil)** (ipeirotis, MIT) — Review the upstream SKILL.md before installation.
- **[claude-code-1password-skill](https://github.com/kcmadden/claude-code-1password-skill)** (kcmadden, MIT) — Claude Code skill for 1Password secrets management — store, read, and inject API keys and credentials using the op CLI
