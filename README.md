...
- **[daikenja](https://github.com/by-carlos/daikenja)** (by-carlos, MIT) — Not an assistant — a sage you consult in the shape of a Claude Code plugin. It knows your work, the work around you, and where to go next.
- **[plot](https://github.com/plot-pm/plot)** (plot-pm, CC0-1.0) — Git-native planning workflow for software development
...
- **[floh-skills](https://github.com/ASNNetworks/floh-skills)** (ASNNetworks, MIT) — Agent Skills by FLOH. Portable SKILL.md capabilities for Claude Code, Codex, Gemini CLI, Cursor and other agent clients.
- **[agent-stack](https://github.com/ssheleg/agent-stack)** (ssheleg, MIT) — Production patterns for building AI agent orchestrators — and for billing the LLM access they burn.
